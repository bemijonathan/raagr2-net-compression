...
def test_model():
    ...
    model = load_trained_model("mlruns/256189084261493978/e3199993a05b4137b2c9ba40945137fe/artifacts/checkpoints/dlu_net_model_epoch_35.pth")
...
def statistics():
    shared_model = load_trained_model("mlruns/256189084261493978/e3199993a05b4137b2c9ba40945137fe/artifacts/checkpoints/dlu_net_model_epoch_35.pth")
