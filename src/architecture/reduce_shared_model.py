...
class ReASPP3(nn.Module):
    def __init__(self, in_channels, out_channels, r=3):
        ...
        self.shared_dw_weight_1 = nn.Parameter(
            torch.randn(in_channels, 1, 3, 3))
        self.shared_dw_bias_1 = nn.Parameter(
            torch.randn(in_channels))

        self.shared_dw_weight_2 = nn.Parameter(
            torch.randn(in_channels, 1, 3, 3))
        ...
        self.block1 = SharedDepthwiseBlock(
            ...
            shared_dw_weight=self.shared_dw_weight_1,
            shared_dw_bias=self.shared_dw_bias_1
        )
        ...
        self.block3 = SharedDepthwiseBlock(
            ...
            shared_dw_weight=self.shared_dw_weight_2,
            shared_dw_bias=self.shared_dw_bias_2
        )
